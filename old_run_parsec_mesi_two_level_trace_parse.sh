...
# declare -A binaries=( ["default"]="$GEM5_HOME/build/X86_MESI_Two_Level/gem5.debug" \
#                        )

# OUT=./jake/superDebug/outdir
# RESULTS=./jake/superDebug/resultsdir
...
# # GEM5_FLAGS+="--debug-flags=LUKAS,RubyLUKAS"
# # GEM5_FLAGS+="--debug-flags=LUKAS"
# # GEM5_FLAGS+="--debug-flags=RubyLUKAS,RubyLUKAS2"
