...
parser.add_argument(
    "--l1d_pref",
    type=str,
    choices=["stride", "spp", "cs395t", "no"],
    help="L1 data prefetcher",
)
parser.add_argument(
    "--l1d_repl",
    type=str,
    choices=["lru", "plru", "cs395t"],
    help="L1 data replacement policy",
)
...
parser.add_argument(
    ...
    type=str,
    choices=["stride", "spp", "cs395t", "no"],
    help="L1 inst prefetcher",
)
parser.add_argument(
    "--l1i_repl",
    type=str,
    choices=["lru", "plru", "cs395t"],
    help="L1 inst replacement policy",
)
...
parser.add_argument(
    "--llc_repl",
    type=str,
    choices=["lru", "plru", "cs395t", "rare", "rpc"],
...
def get_l1d_params() -> Dict[str, Any]:
    ...
    if simarglib.get("l1d_pref") == "stride":
        ...
        params["prefetcher_params"] = {"degree": 1}
        ...
        params["prefetcher_params"] = {"size": 2048}
    ...
    if simarglib.get("l1d_repl") == "lru":
        ...
        params["replacement_params"] = {"size": 2048}
        # You can either read parameters from the command line
        # (by adding more parser.add_argument calls) or
        # hardcode the parameters you want here.
        # TODO: Add more params here (or process them)
...
def get_llc_params() -> Dict[str, Any]:
    ...
    if simarglib.get("llc_repl") == "lru":
        ...
        params["ReplacementPolicyCls"] = CS395TRP
        params["replacement_params"] = {}
    elif simarglib.get("llc_repl") == "rare":
        params["ReplacementPolicyCls"] = RARE
        params["replacement_params"] = {}
