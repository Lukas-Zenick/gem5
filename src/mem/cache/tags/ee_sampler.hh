...
//     bool sample(uint64_t addr, uint64_t access_type, uint8_t *curr_timestamp, int set, uint16_t *last_PC, uint8_t *last_timestamp, bool hit, bool *evict, bool *sample_hit, int core_id, uint64_t inf_rd);
...
//     void train(uint64_t last_PC, bool sampled_cache_hit, uint8_t curr_timestamp, uint8_t last_timestamp, bool evict, uint64_t type);

//     uint16_t predict(uint64_t addr, uint64_t access_type, bool hit, int core_id, int etr_inf);

//     bool bypass(uint64_t addr, uint64_t access_type, uint8_t max_etr, bool hit, int core_id, bool cache_line_valid);
...
class SampledCache
{
  ...
  public:
    ...
    bool sample(uint64_t addr, uint64_t PC, uint8_t *curr_timestamp, int set, uint16_t *last_PC, uint8_t *last_timestamp, bool hit, bool *evict, bool *sample_hit, int core_id, uint64_t inf_rd, bool log);
